...
if __name__ == "__main__":
    ...
    for list in course_lists:
        if list['course']['name'] == course_name:
    ...
    video_info = json.loads(requests.get('https://changjiang.yuketang.cn/c27/online_courseware/xty/kls/pub_news/468084/',headers=headers,cookies=cookies).text)
    time.sleep(random.randint(1, 3))
